...
public class ArgumentParser {
	...
	public static boolean isFlag(String arg) {
		...
		int firstIndex = arg.codePointAt(1);
		return !(Character.isWhitespace(firstIndex) || Character.isDigit(firstIndex));
...
//		}
	...
	public boolean hasValue(String flag) {
		...
		if(hasFlag(flag) == false) return false;
		if(map.get(flag) == null) return false;
		return true;
	}
